...
- [GENERAL FAQ](maunal__faq?id=general-faq)
  - [Basic Facts](manual__faq?id=basic-facts)
    ...
    - [**What is the hard cap of TFT? How much TFT can there ever be?**](?id=what-is-the-hard-cap-of-tft-how-much-tft-can-there-ever-be)
    - [**I've read that Threefold is Carbon Negative, what does this imply?**](?id=ive-read-that-threefold-is-carbon-negative-what-does-this-imply)
    - [**Who are the people working for Threefold?**](?id=who-are-the-people-working-for-threefold)
    - [**Who are the co-founders of Threefold?**](?id=who-are-the-co-founders-of-threefold)
    - [**In a nutshell, what can be said of the Threefold team?**](?id=in-a-nutshell-what-can-be-said-of-the-threefold-team)
    - [**What is the mission of Threefold?**](?id=what-is-the-mission-of-threefold)
    - [**Does Threefold have any partners?**](?id=does-threefold-have-any-partners)
    - [**What are the priorities of Threefold (the Three P of Threefold)? / Threefold is a Planet first project, what does it mean?**](?id=what-are-the-priorities-of-threefold-the-three-p-of-threefold--threefold-is-a-planet-first-project-what-does-it-mean)
    - [**I want to farm TFT with a 3node. What are my choices?**](?id=i-want-to-farm-tft-with-a-3node-what-are-my-choices)
    - [**I want to buy a certified 3node server from a reliable source. Who are Threefold's partners offering certified 3nodes?**](?id=i-want-to-buy-a-certified-3node-server-from-a-reliable-source-who-are-threefolds-partners-offering-certified-3nodes)
    - [**I want to help build the new Internet. How can I become a Threefold certified 3node partner?**](?id=i-want-to-help-build-the-new-internet-how-can-i-become-a-threefold-certified-3node-partner)
    - [**What is Proof-of-Capacity used by Threefold?**](?id=what-is-proof-of-capacity-used-by-threefold)
    - [**What is Proof-of-Utilization used by Threefold?**](?id=what-is-proof-of-utilization-used-by-threefold)
    - [**How is Threefold registered as an entity?**](?id=how-is-threefold-registered-as-an-entity)
    - [**Where is ThreeFold Tech's headquarters?**](?id=where-is-threefold-techs-headquarters)
    - [**Can I have more information on Threefold Tech NV and Threefold S.A.?**](?id=can-i-have-more-information-on-threefold-tech-nv-and-threefold-sa)
  - [Threefold Communication](?id=threefold-communication)
    - [**Is there a Threefold app for mobile?**](?id=is-there-a-threefold-app-for-mobile)
    - [**I want to reach the Threefold community. What are Threefold social links?**](?id=i-want-to-reach-the-threefold-community-what-are-threefold-social-links)
...
- [USER FAQ](#user-faq)
  ...
  - [Tutorials and Guides](#tutorials-and-guides)
    ...
    - [**To deploy a load on the TF Grid, I need to generate SSH keys. How can I generate SSH keys on MAC, Linux or Windows?**](#to-deploy-a-load-on-the-tf-grid-i-need-to-generate-ssh-keys-how-can-i-generate-ssh-keys-on-mac-linux-or-windows)
...
- [FARMER FAQ](#farmer-faq)
  - [TFT Farming Basics](#tft-farming-basics)
    ...
    - [**What are the minting periods for 2022?**](#what-are-the-minting-periods-for-2022)
  ...
  - [Farming Rewards and Related Notions](#farming-rewards-and-related-notions)
    ...
    - [**I received my farming rewards, now I want to sell my TFT. How can I do this?**](#i-received-my-farming-rewards-now-i-want-to-sell-my-tft-how-can-i-do-this)
    - [**How can I swap TFT on Stellar blochain?**](#how-can-i-swap-tft-on-stellar-blochain)
  ...
  - [3node Farming Requirements](#3node-farming-requirements)
    ...
    - [**How much AC power do you need (in BTU) to compensate for the heat generated by the servers? How can I ensure proper relative humidity range for my 3node farm?**](#how-much-ac-power-do-you-need-in-btu-to-compensate-for-the-heat-generated-by-the-servers-how-can-i-ensure-proper-relative-humidity-range-for-my-3node-farm)
    ...
    - [**What is the maximum/minimum temperature and relative humidity a 3node server can handle?**](#what-is-the-maximumminimum-temperature-and-relative-humidity-a-3node-server-can-handle)
  ...
  - [Building a 3node - Steps and Details](#building-a-3node---steps-and-details)
    ...
    - [**What can you do to zero out your disks? How can I wipe the disks of my 3node with Linux?**](#what-can-you-do-to-zero-out-your-disks-how-can-i-wipe-the-disks-of-my-3node-with-linux)
    ...
    - [**Do I need to enable virtualization in BIOS/UEFI?**](#do-i-need-to-enable-virtualization-in-biosuefi)
    - [**How can I boot a 3node with a Zero-OS bootstrap image?**](#how-can-i-boot-a-3node-with-a-zero-os-bootstrap-image)
  ...
  - [Farming and Maintenance](#farming-and-maintenance)
    ...
    - [**Why are the 3nodes' resources different on the Threefold Explorer and the Threefold Portal?**](#why-are-the-3nodes-resources-different-on-the-threefold-explorer-and-the-threefold-portal)
...
### **What is the maximum/minimum temperature and relative humidity a 3node server can handle?**
...
### **Do I need to enable virtualization in BIOS/UEFI?**
